	...
	<div>
		<div class="home_box">
			...
			<div class="homeList_view">
				<div class="homeList_title">商家信息展示</div>
				<div class="home_list_two">
					<mySwiper :data="shangjiaxinxiHomeList" :type="3"
						:loop="true"
						:navigation="true"
						:pagination="false"
						:paginationType="2"
						...
						<template #default="scope">
							<div class="home_item animation_box" @click="detailClick('shangjiaxinxi',scope.row.id)">
								<div class="home_img_box">
									<img class="home_img" v-if="isHttp(scope.row.shangjiatupian)" :src="scope.row.shangjiatupian.split(',')[0]" alt="">
									<img class="home_img" v-else :src="scope.row.shangjiatupian?$config.url + scope.row.shangjiatupian.split(',')[0]:''" alt="">
								</div>
								<div class="home_content">
									<div class='home_title'>
										商家名称：{{scope.row.shangjiamingcheng}}
									</div>
									<div class='home_title'>
				...
				<div class="homeList_more_view" @click="moreClick('shangjiaxinxi')">
					<span class="homeList_more_text">LEARN MORE</span>
				</div>
			</div>
			<!-- 菜品信息首页展示 -->
			<div class="homeList_view">
				<div class="homeList_title">菜品信息展示</div>
				<div class="home_list_two">
					<mySwiper :data="caipinxinxiHomeList" :type="3"
						:loop="true"
						:navigation="true"
						:pagination="false"
						:paginationType="2"
						...
						:slidesPerColumn="1">
						<template #default="scope">
							<div class="home_item animation_box" @click="detailClick('caipinxinxi',scope.row.id)">
								<div class="home_img_box">
								...
								<div class="home_content">
									<div class='home_title'>
										菜品名称：{{scope.row.caipinmingcheng}}
									</div>
									<div class='home_title'>
				...
				<div class="homeList_more_view" @click="moreClick('caipinxinxi')">
					<span class="homeList_more_text">LEARN MORE</span>
				</div>
			</div>
			<!-- 新闻资讯 -->
...
<script setup>
	...
	//商家信息首页展示
	const shangjiaxinxiHomeList = ref([])
	const getshangjiaxinxiHomeList = () => {
		context?.$http({
			url: 'shangjiaxinxi/list',
			method: 'get',
			params: {
				page: 1,
				limit: 12
			...
			shangjiaxinxiHomeList.value = res.data.data.list
		})
	}
	//菜品信息首页展示
	const caipinxinxiHomeList = ref([])
	const getcaipinxinxiHomeList = () => {
		context?.$http({
			url: 'caipinxinxi/list',
			method: 'get',
			params: {
				page: 1,
				limit: 12
			...
			caipinxinxiHomeList.value = res.data.data.list
		})
	}
	//新闻资讯弹窗
	...
	const init = () => {
		//商家信息首页展示
		getshangjiaxinxiHomeList()
		//菜品信息首页展示
		getcaipinxinxiHomeList()
		//新闻资讯
		getNewsList()
	}
	init()
