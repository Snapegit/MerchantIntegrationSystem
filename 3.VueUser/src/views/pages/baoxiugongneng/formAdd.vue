...
<template>
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0 10%","margin":"40px auto 60px","color":"#666","background":"#fff","width":"100%","fontSize":"14px","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				<el-col :span="24">
					<el-form-item label="保修时间" prop="baoxiushijian">
						<el-date-picker
							class="list_date"
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.baoxiuneirong = res.data.data.baoxiuneirong.replace(reg,'../../../cl3222741/file');
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		context?.$http({
			...
			if(json.hasOwnProperty('shangjiadizhi') && context?.$toolUtil.storageGet("frontRole")!="管理员"){
