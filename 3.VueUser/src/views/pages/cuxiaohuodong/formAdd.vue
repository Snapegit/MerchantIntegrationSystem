	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0 10%","margin":"40px auto 60px","color":"#666","background":"#fff","width":"100%","fontSize":"14px","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="优惠方式" prop="youhuifangshi">
						<el-input class="list_inp" v-model="form.youhuifangshi" placeholder="优惠方式"
							 type="text" 							:readonly="!isAdd||disabledForm.youhuifangshi?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="24">
					<el-form-item label="促销条件" prop="cuxiaotiaojian">
						<el-input class="list_inp" v-model="form.cuxiaotiaojian" placeholder="促销条件"
							 type="text" 							:readonly="!isAdd||disabledForm.cuxiaotiaojian?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="24">
					<el-form-item label="规则说明" prop="guizeshuoming">
						<el-input v-model="form.guizeshuoming" placeholder="规则说明" type="textarea"
						:readonly="!isAdd||disabledForm.guizeshuoming?true:false"
						/>
					</el-form-item>
				</el-col>
			</el-row>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='youhuifangshi'){
					form.value.youhuifangshi = row[x];
					disabledForm.value.youhuifangshi = true;
					continue;
				}
				if(x=='cuxiaotiaojian'){
					form.value.cuxiaotiaojian = row[x];
					disabledForm.value.cuxiaotiaojian = true;
					continue;
				}
				if(x=='guizeshuoming'){
					form.value.guizeshuoming = row[x];
					disabledForm.value.guizeshuoming = true;
					continue;
				}
