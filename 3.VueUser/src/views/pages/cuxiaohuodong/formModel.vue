	...
	<div class="app-contain" :style='{"padding":"30px 10% 30px","margin":"0px auto","alignItems":"flex-start","color":"#666","flexWrap":"wrap","display":"flex","width":"100%","fontSize":"14px","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">优惠方式</div>
					<div  class="info_text" >{{detail.youhuifangshi}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">促销条件</div>
					<div  class="info_text" >{{detail.cuxiaotiaojian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">规则说明</div>
					<div  class="info_text" >{{detail.guizeshuoming}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('cuxiaohuodong','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('cuxiaohuodong','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
