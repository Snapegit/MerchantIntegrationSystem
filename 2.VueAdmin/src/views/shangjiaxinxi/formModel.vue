				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="商家公告" prop="shangjiagonggao">
							<editor :value="form.shangjiagonggao" placeholder="请输入商家公告" :readonly="!isAdd||disabledForm.shangjiagonggao?true:false"
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.shangjiagonggao = res.data.data.shangjiagonggao?(res.data.data.shangjiagonggao.replace(reg,'../../../cl3222741/file')):'';
