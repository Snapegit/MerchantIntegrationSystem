...
public class ShangjiaxinxiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ShangjiaxinxiEntity u = shangjiaxinxiService.selectOne(new EntityWrapper<ShangjiaxinxiEntity>().eq("shangjiazhanghao", username));
        if(u==null || !u.getShangjiamima().equals(password)) {
            return R.error("账号或密码不正确");
        }
		String token = tokenService.generateToken(u.getId(), username,"shangjiaxinxi",  "管理员" );
    ...
    public R register(@RequestBody ShangjiaxinxiEntity shangjiaxinxi){
    	//ValidatorUtils.validateEntity(shangjiaxinxi);
    	ShangjiaxinxiEntity u = shangjiaxinxiService.selectOne(new EntityWrapper<ShangjiaxinxiEntity>().eq("shangjiazhanghao", shangjiaxinxi.getShangjiazhanghao()));
		if(u!=null) {
			return R.error("注册用户已存在");
		}
		Long uId = new Date().getTime();
		shangjiaxinxi.setId(uId);
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        ShangjiaxinxiEntity u = shangjiaxinxiService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
        ...
        shangjiaxinxiService.updateById(u);
    ...
    public R save(@RequestBody ShangjiaxinxiEntity shangjiaxinxi, HttpServletRequest request){
		...
		shangjiaxinxi.setId(new Date().getTime());
        shangjiaxinxiService.insert(shangjiaxinxi);
        return R.ok();
    }
